                            ...
                            {changeRequests.map((request) => (
                                <TableRow key={request._id}>
                                    ...
                                    <TableCell>
                                        ...
                                        <Button onClick={() => handleOpenConfirmDialog(() => handleAcceptRequest(request._id), i18n('confirm_action'), i18n('are_you_sure_confirm'))}>{i18n('accept')}</Button>
                                        <Button onClick={() => handleOpenConfirmDialog(() => handleDiscardRequest(request._id), i18n('discard_action'), i18n('are_you_sure_discard'))}>{i18n('discard')}</Button>
                                    </TableCell>
                                </TableRow>
                            ))}
                        </TableBody>
