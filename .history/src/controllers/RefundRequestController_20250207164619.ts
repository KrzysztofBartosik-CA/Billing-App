...
export const getRefundRequestById = async (req: Request, res: Response) => {
    try {
        ...
        const refundRequestDTO = new RefundRequestDTO(request.id, user as unknown as UserType, invoice as unknown as InvoiceType, refundRequest.reason, refundRequest.requestDate);
